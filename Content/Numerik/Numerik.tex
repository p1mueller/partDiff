...
$\boxed{g''(x)\approx \frac{g(x-\Delta x)-2 g(x) + g(x+ \Delta x)}{\Delta x^2}}$
...
\\
gesucht: $ \tilde{u}_1(\frac{1}{3}) $ und $ \tilde{u}_2(\frac{2}{3}) $
\\
lösen: Die Ableitung von $ u'' $ einsetzen, siehe oben, ergibt der allgemeine Gleichung von $ \frac{u(x-\Delta x)-2 u(x) + u(x+ \Delta x)}{\Delta x^2} =4*(u(x)-x) $, für die Punkte P1 und P2 ergibt das.
\\
P1: $ \frac{0-2 \tilde{u}_1(\frac{1}{3}) + \tilde{u}_2(\frac{2}{3})}{(\frac{1}{3})^2} =4*(\tilde{u}_1(\frac{1}{3})-\frac{1}{3}) $
\\
P2: $ \frac{\tilde{u}_1(\frac{1}{3})-2 \tilde{u}_2(\frac{2}{3}) + 2}{(\frac{1}{3})^2} =4*(\tilde{u}_2(\frac{2}{3})-\frac{2}{3}) $
\\
Nun das Gleichungssysteme lösen ergibt $ \tilde{u}_1(\frac{1}{3}) $ und $ \tilde{u}_2(\frac{2}{3}) $          
